...
set_input_delay -clock syncclk -clock_fall -min -add_delay 5.750 [get_ports {{READOUT2_P[0]} {READOUT2_P[1]} {READOUT2_P[2]} {READOUT2_P[3]} {READOUT2_P[4]} {READOUT2_P[5]} {READOUT_P[6]} {READOUT_P[7]}}]
...
set_input_delay -clock syncclk -clock_fall -min -add_delay 5.750 [get_ports {{READOUT3_P[0]} {READOUT3_P[1]} {READOUT3_P[2]} {READOUT3_P[3]} {READOUT3_P[4]} {READOUT3_P[5]} {READOUT_P[6]} {READOUT_P[7]}}]
...
set_input_delay -clock syncclk -clock_fall -min -add_delay 5.750 [get_ports {{READOUT4_P[0]} {READOUT4_P[1]} {READOUT4_P[2]} {READOUT4_P[3]} {READOUT4_P[4]} {READOUT4_P[5]} {READOUT_P[6]} {READOUT_P[7]}}]
