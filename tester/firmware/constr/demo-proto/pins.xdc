# XDC for the picoTDC Demo Board - Prototype version EDA-04186 with test socket
# DPo - ML
# 11.10.2021
...
#I2C Silicon chip
set_property IOSTANDARD LVCMOS18 [get_ports SCL_SILICON_CONTROL]
set_property IOSTANDARD LVCMOS18 [get_ports SDA_SILICON_CONTROL]
set_property DRIVE 4 [get_ports SDA_SILICON_CONTROL]
set_property DRIVE 4 [get_ports SCL_SILICON_CONTROL]
set_property PULLUP true [get_ports SCL_SILICON_CONTROL]
set_property PULLUP true [get_ports SDA_SILICON_CONTROL]
set_property PACKAGE_PIN BB23 [get_ports SDA_SILICON_CONTROL]
set_property PACKAGE_PIN BB24 [get_ports SCL_SILICON_CONTROL]
...
# testboard TEST SMA
set_property IOSTANDARD DIFF_SSTL12 [get_ports TEST_1_P]
set_property IOSTANDARD DIFF_SSTL12 [get_ports TEST_1_N]
set_property PACKAGE_PIN AD40 [get_ports TEST_1_P]
set_property PACKAGE_PIN AD41 [get_ports TEST_1_N]

set_property IOSTANDARD DIFF_SSTL12 [get_ports TEST_2_P]
set_property IOSTANDARD DIFF_SSTL12 [get_ports TEST_2_N]
set_property PACKAGE_PIN AB41 [get_ports TEST_2_P]
set_property PACKAGE_PIN AB42 [get_ports TEST_2_N]
...
set_property PACKAGE_PIN T36 [get_ports SYNC_P]
set_property PACKAGE_PIN R37 [get_ports SYNC_N]
...
set_property PACKAGE_PIN AD38 [get_ports {READOUT_P[4]}]
set_property PACKAGE_PIN AE38 [get_ports {READOUT_N[4]}]
...
set_property PACKAGE_PIN AF42 [get_ports {READOUT_P[5]}]
set_property PACKAGE_PIN AG42 [get_ports {READOUT_N[5]}]
...
set_property PACKAGE_PIN AJ38 [get_ports {READOUT_P[7]}]
set_property PACKAGE_PIN AK38 [get_ports {READOUT_N[7]}]
...
set_property PACKAGE_PIN P32 [get_ports {READOUT2_P[0]}]
set_property PACKAGE_PIN P33 [get_ports {READOUT2_N[0]}]
...
set_property PACKAGE_PIN R38 [get_ports {READOUT2_P[6]}]
set_property PACKAGE_PIN R39 [get_ports {READOUT2_N[6]}]
...
set_property PACKAGE_PIN W36 [get_ports {READOUT3_P[4]}]
set_property PACKAGE_PIN W37 [get_ports {READOUT3_N[4]}]
...
set_property PACKAGE_PIN V39 [get_ports {READOUT3_P[7]}]
set_property PACKAGE_PIN V40 [get_ports {READOUT3_N[7]}]
...
set_property PACKAGE_PIN AB36 [get_ports {READOUT4_P[4]}]
set_property PACKAGE_PIN AB37 [get_ports {READOUT4_N[4]}]
...
#I2C PicoTDC controller

set_property PACKAGE_PIN P38 [get_ports SCL_PICOTDC_CONTROL_NEW]
set_property IOSTANDARD LVCMOS12 [get_ports SCL_PICOTDC_CONTROL_NEW]
set_property DRIVE 4 [get_ports SCL_PICOTDC_CONTROL_NEW]

set_property PACKAGE_PIN P37 [get_ports SDA_PICOTDC_CONTROL_NEW]
set_property IOSTANDARD LVCMOS12 [get_ports SDA_PICOTDC_CONTROL_NEW]
set_property DRIVE 4 [get_ports SDA_PICOTDC_CONTROL_NEW]

# PicoTDC Resets on FMC2
...
set_property PACKAGE_PIN U31 [get_ports {HTRX_P[61]}]
set_property PACKAGE_PIN T31 [get_ports {HTRX_N[61]}]
